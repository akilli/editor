...
const data = [
    ...
    {name: 'details', children: ['figure', 'p', 'summary']},
    {name: 'dfn', group: 'text'},
    {name: 'figcaption', children: ['text'], editable: true},
    {name: 'figure', attributes: ['class'], children: ['blockquote', 'figcaption', 'media', 'table']},
    {name: 'h2', group: 'heading', editable: true},
    {name: 'h3', group: 'heading', editable: true},
    {name: 'i', group: 'text'},
    ...
    {name: 'li', children: ['br', 'text'], editable: true},
    {name: 'kbd', group: 'text'},
    {name: 'mark', group: 'text'},
    {name: 'ol', group: 'list', children: ['li']},
    {name: 'p', children: ['br', 'text'], editable: true},
    {name: 'q', group: 'text'},
